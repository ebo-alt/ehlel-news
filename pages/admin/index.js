...
export default function Home() {
  ...
  function userUpdate(username, lastname, phoneNumber, password) {
    axios
      .put(`${BACKEND_URL}/users/${editUserId}`, {
        username,
        lastname,
        phoneNumber,
        password,
  ...
  function userHadgalah(username, lastname, phoneNumber, password) {
